...
public class DescriptionQuery implements CaseComponent {
     ...
     * @param avCheck - Среднее значение чека по сумме.
     * @param itemsCount - Среднее значение чека по количеству.
     * @param impl - Выполнение плана.
     */
    public DescriptionQuery(Float avCheck, Float itemsCount, Float impl) {
